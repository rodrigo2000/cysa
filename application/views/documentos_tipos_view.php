                ...
                <tbody>
                    <?php foreach ($registros as $r): ?>
                        <tr>
                            ...
                            <td class="text-xs-center align-middle"><?= $r['documentos_tipos_codigo']; ?></td>
                            <td class="align-middle"><?= $r['documentos_tipos_nombre']; ?></td>
                            <td class="text-xs-center align-middle"><?= $r['documentos_tipos_abreviacion']; ?></td>
