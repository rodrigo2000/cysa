        ...
        <div class="table-responsive">
            <table class="table table-bordered table-hover table-sm table-striped table-hover dataTable">
                <thead class="thead-inverse">
                    <tr>
                        <th width="10">🆔</th>
                        <th width="100">Tipo de documento</th>
                        <th width="100">Constante</th>
                        <th>Descripción</th>
                        <th>&nbsp;</th>
                    </tr>
                </thead>
                <tbody>
                    <?php foreach ($registros as $r): ?>
                        <tr>
                            ...
                            <td class="text-xs-center align-middle"><?= $r['documentos_constantes_nombre']; ?></td>
                            <td class="align-middle"><?= $r['documentos_constantes_descripcion']; ?></td>
