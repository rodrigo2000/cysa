    ...
    <div class="card-block">
        <form class="form-horizontal" novalidate="novalidate" action="<?= $urlAction; ?>" method="post">
            <div class="form-group row">
                <label for="auditorias_areas_siglas" class="col-sm-3 control-label">Sigla</label>
                <div class="col-sm-6 col-md-6">
                    <input type="text" id="auditorias_areas_siglas" name="auditorias_areas_siglas" class="form-control" value="<?= isset($r) ? $r['auditorias_areas_siglas'] : ''; ?>">
                    <?= form_error('auditorias_areas_siglas'); ?>
                </div>
            </div>
            <div class="form-group row">
